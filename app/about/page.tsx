      ...
      <main className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold mb-4">
            About{' '}
            <span className="text-primary">Eburutu</span>{' '}
        ...
        <div className="mb-16">
          <div className="bg-gradient-to-r from-primary to-accent rounded-2xl p-8 md:p-12 text-white text-center">
            ...
            <p className="text-xl leading-relaxed max-w-4xl mx-auto">
              ...
              in the UK with authentic products, services, and cultural experiences from across
              Africa. We believe in preserving heritage, supporting artisans, and building bridges
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <div>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Eburutu Mart was born from a simple yet powerful observation: members of the
                African diaspora in the UK struggled to find authentic products that connected
                them to their cultural roots.
              </p>
              <p>
                Founded in 2024, we started as a community initiative to help African
                entrepreneurs showcase their products to a wider audience. We are building
                the go-to platform for authentic African commerce in the UK.
              </p>
              <p>
                Our platform goes beyond transactions — we&apos;re building a community that
                celebrates African heritage, supports emerging businesses, and creates meaningful
          ...
          <div className="bg-muted/20 rounded-2xl p-8 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Be part of the community we&apos;re building together
              </p>
            </div>
          </div>
        </div>
      ...
      <main className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center bg-gradient-to-br from-primary/5 via-accent/5 to-emerald-500/5 rounded-2xl p-8 md:p-12 border border-primary/10">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Register now to discover authentic African products or start selling your own
            cultural treasures to our growing marketplace.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link href="/products">
              <Card className="p-6 text-center hover:shadow-xl transition-all duration-300 border-2 border-emerald-200 hover:border-emerald-400 bg-gradient-to-br from-emerald-50 to-emerald-100">
                ...
                <h4 className="font-bold text-lg mb-2 text-emerald-700">For Buyers</h4>
            ...
            <Link href="/auth/register">
              <Card className="p-6 text-center hover:shadow-xl transition-all duration-300 border-2 border-amber-200 hover:border-amber-400 bg-gradient-to-br from-amber-50 to-amber-100">
                ...
                <h4 className="font-bold text-lg mb-2 text-amber-700">For Sellers</h4>
                <p className="text-sm text-muted-foreground mb-4">
