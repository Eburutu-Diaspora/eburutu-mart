...
const TikTokIcon = ({ className }: { className?: string }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24">
    <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.22 8.22 0 004.81 1.54V6.76a4.85 4.85 0 01-1.04-.07z" />
  </svg>
)
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4">
              ...
              {/* Feature Pills — "Verified Sellers" removed, replaced with "Trusted Community" */}
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                <div className="flex items-center space-x-1 text-xs bg-emerald-500/20 px-2 py-1 rounded-full border border-emerald-500/30">
                  <Users className="h-3 w-3 text-emerald-400" />
                  <span className="text-emerald-300">Trusted Community</span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  {socialLinks.map((social) => (
                    <Link
                      ...
                      className={`p-2 bg-slate-800/60 rounded-full border border-slate-700/50 text-slate-400 transition-all duration-300 hover:scale-110 hover:border-slate-600/50 ${social.color}`}
            ...
            {/* For Sellers - Takes 2 columns — "Seller Verification" removed, replaced with "How It Works" */}
            <div className="lg:col-span-2">
              <h3 className="font-bold text-white mb-4 flex items-center text-sm">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/safety-guide" className="text-slate-400 hover:text-amber-400 transition-colors flex items-center group text-sm">
                    <span className="w-0 group-hover:w-2 h-0.5 bg-amber-400 mr-0 group-hover:mr-2 transition-all duration-300"></span>
                    How It Works
                  </Link>
                </li>
              ...
              {isSubscribed ? (
                ...
                <form onSubmit={handleNewsletterSubmit} className="space-y-3">
                  ...
                  <button
                    type="submit"
                    disabled={isSubscribing}
                    className="w-full bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-medium py-2.5 px-4 rounded-lg hover:from-emerald-600 hover:to-teal-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm"
                  >
                    {isSubscribing ? (
                      <>
